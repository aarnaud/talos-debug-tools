...
RUN apt-get update && apt-get -y install \
    xz-utils python3 python3-dev python3-setuptools make gcc-13 gcc clang pkg-config llvm binutils-dev libreadline-dev libelf-dev libnuma-dev libpci-dev libcap-dev gettext curl flex bison libssl-dev libslang2-dev libtraceevent-dev
...
ARG CC="gcc" # gcc-13 require for kernel 6.6
